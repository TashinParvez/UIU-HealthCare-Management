...
<body>
    <div class="flex min-h-screen">
        ...
        <div class="content">
            ...
            $patients = [
                ['id' => 1, 'name' => 'Shafayet Hossain', 'visit' => 'Weekly Visit', 'avatar_color' => 'bg-blue-500'],
                ['id' => 2, 'name' => 'Tashin Parvez', 'visit' => 'Check-up', 'avatar_color' => 'bg-red-500'],
                ['id' => 3, 'name' => 'AH Noman', 'visit' => 'Report', 'avatar_color' => 'bg-green-500'],
                ['id' => 4, 'name' => 'Aranya Das', 'visit' => 'Weekly Visit', 'avatar_color' => 'bg-yellow-500'],
            ];
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div
                    ...
                    <div>
                        <h1 class="text-lg font-semibold">Good Morning, Shafayet!</h1>
                        <p class="text-sm">Visits for Today</p>
                        <h2 class="text-2xl font-bold mt-2">104</h2>
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div class="bg-white bg-opacity-20 rounded-lg p-4 text-center">
                                <h2 class="text-xl font-bold">40</h2>
                                <p class="text-sm">New Patients <span class="text-green-300">+5%</span></p>
                            </div>
                            <div class="bg-white bg-opacity-20 rounded-lg p-4 text-center">
                                <h2 class="text-xl font-bold">64</h2>
