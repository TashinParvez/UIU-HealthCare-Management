...
<head>
    ...
    <title>Prescription Page 06 - Schedule Follow-Up</title>
    <!-- Bootstrap CSS -->
    ...
    <style>
        ...
        .prescription-section .followup-row {
            display: flex;
            align-items: center;
            margin-bottom: 15px;
        }

        .prescription-section .followup-row input[type="date"],
        .prescription-section .followup-row input[type="time"] {
