        ...
        <div class="flex-1 p-8 content">
            ...
            <div class="relative">
                ...
                <div id="cards-container" class="flex space-x-4 overflow-x-auto hide-scrollbar">
                    <!-- Patient Card -->
                    <div class="flex-none w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8">
                    ...
                    <div class="flex-none w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8">
                        ...
                        <ul role="list" class="space-y-5 my-7">
                            <li class="flex items-center">
                                <span class="text-base font-normal leading-tight text-gray-500 ms-3">5 team members</span>
                            </li>
                        </ul>
                        <button type="button"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">
